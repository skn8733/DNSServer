...
password = 'skn8733@nyu.edu'  # replace with your NYU email
input_string = 'AlwaysWatching'

# Encrypt and store the data for DNS exfiltration
encrypted_value = encrypt_with_aes(input_string, password, salt)

# DNS record dictionary with additional entries
dns_records = {
    'example.com.': {
        ...
        dns.rdatatype.SOA: (
            'ns1.example.com.', 'admin.example.com.', 2023081401, 
    ...
    'nyu.edu.': {
        ...
        dns.rdatatype.TXT: (str(encrypted_value),),  # store encrypted data here
...
def run_dns_server():
    ...
    while True:
        try:
            ...
            # Check if a record matches the question in dns_records
